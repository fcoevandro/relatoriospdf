<%-- 
    Document   : relatoriodependencia
    Created on : 06/04/2016, 15:35:46
    Author     : Administrador
--%>

<%@page import="Classes.ConexaoMySQL"%>
...
ConexaoMySQL conexion=new ConexaoMySQL();
/*Establecemos la ruta del reporte*/ 
File reportFile = new File(application.getRealPath("RELATORIOS/REL_DEPENDENCIA.jasper"));
...
parameters.put("Nome_da_Dependencia", dependencia); 
